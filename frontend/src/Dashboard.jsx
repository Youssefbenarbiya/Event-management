...
function Dashboard() {
  ...
  const handleSaveClick = async () => {
    try {
      const response = await fetch(
        `https://localhost:9090/event/${editingEvent._id}`,
        {
          method: "PUT",
          headers: {
            Authorization: `${token}`,
  ...
  const handleDeleteClick = async (eventId) => {
    try {
      const response = await fetch(`https://localhost:9090/event/${eventId}`, {
        method: "DELETE",
        headers: {
          Authorization: `${token}`,
        },
  ...
  const handleCancelEventClick = async (eventId) => {
    try {
      const response = await fetch(`https://localhost:9090/ticket/${eventId}`, {
        method: "DELETE",
        headers: {
          Authorization: `${token}`,
        },
